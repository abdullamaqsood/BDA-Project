...
def consume_and_store_data(topic, hdfs_path, batch_size=200):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=200, help="Number of messages to process per batch")
