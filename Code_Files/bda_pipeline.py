...
consume_customer_data = BashOperator(
    ...
    bash_command='python /usr/local/airflow/LoadScripts/customer_script.py --topic CustomerTopic --hdfs_path hdfs://hadoop-namenode-bda:9000/airflow/customer_data_raw/ --batch_size 200',
    dag=dag,
)
...
consume_order_data = BashOperator(
    ...
    bash_command='python /usr/local/airflow/LoadScripts/order_script.py --topic OrderTopic --hdfs_path hdfs://hadoop-namenode-bda:9000/airflow/order_data_raw/ --batch_size 200',
    dag=dag,
)
