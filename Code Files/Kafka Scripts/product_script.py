...
def consume_and_store_data(topic, hdfs_path, batch_size=10):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=10, help="Number of messages to process per batch")
